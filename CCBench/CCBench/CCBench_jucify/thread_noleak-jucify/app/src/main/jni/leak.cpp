...
Java_org_cao_thread_1noleak_MainActivity_send(JNIEnv *env, jobject thiz, jstring data) {
    // TODO: implement send()
    jstring msg = env->NewStringUTF("data");
    pthread_t th1, th2;
    ...
    (*env).CallStaticIntMethod(jniLog, logDId, tag, tag);//noleak
    return;
}