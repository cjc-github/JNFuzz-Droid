...
Java_org_cao_native_1method_1overloading_MainActivity_send__I(JNIEnv *env, jobject thisObj,
                                                                   jint data) {
    LOGI("%s", data); // leak
    return;
}
...
extern "C" JNIEXPORT void JNICALL
Java_org_cao_native_1method_1overloading_MainActivity_send___3I_3Ljava_lang_String_2Ljava_lang_String_2D(
