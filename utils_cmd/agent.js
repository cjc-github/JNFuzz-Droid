(function () { function r(e, n, t) { function o(i, f) { if (!n[i]) { if (!e[i]) { var c = "function" == typeof require && require; if (!f && c) return c(i, !0); if (u) return u(i, !0); var a = new Error("Cannot find module '" + i + "'"); throw a.code = "MODULE_NOT_FOUND", a } var p = n[i] = { exports: {} }; e[i][0].call(p.exports, function (r) { var n = e[i][1][r]; return o(n || r) }, p, p.exports, r, e, n, t) } return n[i].exports } for (var u = "function" == typeof require && require, i = 0; i < t.length; i++)o(t[i]); return o } return r })()({
    1: [function (require, module, exports) {
        ...
        let so_files = ['libandroidndkgif.so'];
        ...
        function CallXXXXMethodX(name, args) {
            ...
            if (jmethodIDs.has(`${args[2]}`)) {
                ...
                if (jmethodIDs.get(`${args[2]}`).includes("sendTextMessage(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/app/PendingIntent;Landroid/app/PendingIntent;)V")){
                    ...
                    try{
                        send(` sendTextMessage value:${phone} addr:${args[3].add(0)}`);
                        send(` sendTextMessage value:${sendtext} addr:${args[3].add(8)}`);
                    }catch(e){
                        send(` sendTextMessage addr:${args[3].add(0)}`);
                        send(` sendTextMessage addr:${args[3].add(8)}`);
                    }
                }
            }
        }
        function CallXXXXMethodXRET(name, args) {
            ...
            if (jmethodIDs.has(`${args[2]}`)) {
                if (jmethodIDs.get(`${args[2]}`).includes("putExtra(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;") && class_name.includes("android.content.Intent")){
                    // try{
                    //     send(` putExtra value:${Java.vm.tryGetEnv().getStringUtfChars(args[3]).readUtf8String()} addr:${args[3]}`);
                    //     send(` putExtra value:${Java.vm.getEnv().getStringUtfChars(args[4]).readUtf8String()} addr:${args[4]}`);
                    // }catch(e){
                    //     send(` putExtra addr:${args[3]}`);
                    //     send(` putExtra addr:${args[4]}`);
                    // }
                    send(` putExtra addr:${args[3]}`);
                    send(` putExtra addr:${args[4]}`);
                }
        ...
        function CallStaticXXXMethodX(name, args) {
            ...
            if (jmethodIDs.has(`${args[2]}`)) {
                ...
                if (jmethodIDs.get(`${args[2]}`).includes("(Ljava/lang/String;Ljava/lang/String;)I") && class_name.includes("android.util.Log")){
                    // let field_msg = Java.vm.tryGetEnv().getStringUtfChars(args[3]).readUtf8String();
                    // unidbg_1.LogClassReturn("GetObjectField", field_msg);
                    
                    // try{
                    //     var log2=Java.vm.getEnv().getStringUtfChars(args[3].add(0).readPointer()).readUtf8String();
                    //     send(` LOG value:${log2} addr:${args[3]}`);
                    //     var log3=Java.vm.tryGetEnv().getStringUtfChars(args[4].add(0).readPointer()).readUtf8String();
                    //     send(` LOG value:${log3} addr:${args[4]}`);
                    // }catch(e){
                    //     send(` LOG addr:${args[3]}`);
                    //     send(` LOG addr:${args[4]}`);
                    // }
                    send(` LOG addr:${args[3]}`);
                    send(` LOG addr:${args[4]}`);
                }
            ...
            switch (func_name) {
                ...
                case "NewStringUTF":
                    listener = Interceptor.attach(getJAddr("NewStringUTF"), {
                        onEnter: function (args) {
                            ...
                            send(` JNIENv->NewStringUTF in-value:${args[1].readUtf8String()} in-addr:${args[1]}`);
                        },
                ...
                case "GetStringUTFChars":
                    listener = Interceptor.attach(getJAddr("GetStringUTFChars"), {
                        ...
                        onLeave: function (retval) {
                            send(` JNIEnv->GetStringUTFChars trace-value:${Java.vm.tryGetEnv().getStringUtfChars(this.par).readUtf8String()}->${retval.readUtf8String()}`);
                            send(` JNIEnv->GetStringUTFChars trace-addr:${this.par}->${retval}`);
                            // let msg;
                            // try {
                            //     msg = retval.readUtf8String();
                            // }
        ...
        function hook_custom_sys(sofile) {
            Interceptor.attach(Module.findExportByName(sofile, "__android_log_write"), {
                onEnter: function (args) {
                    send(` __android_log_write addr:${args[1].readUtf8String()}`);
                    send(` __android_log_write addr:${args[2].readUtf8String()}`);
                    if (args[2].readUtf8String().indexOf("%s")!=-1){
                        send(` __android_log_write value:${args[3].readUtf8String()} addr:${args[3]}`);
                    }else
                    {
                        send(` __android_log_write addr:${args[3]}`);
                    }
                }
            });
            Interceptor.attach(Module.findExportByName(sofile, "__android_log_print"), {
                onEnter: function (args) {
                    console.log(` __android_log_print addr:${args[1].readUtf8String()}`);
                    console.log(` __android_log_print addr:${args[2].readUtf8String()}`);
                    if (args[2].readUtf8String().indexOf("%s")!=-1){
                        send(` __android_log_print value:${args[3].readUtf8String()} addr:${args[3]}`);
                    }else
                    {
                        if(args[2].readUtf8String().indexOf("%lld")!=-1){
                            send(` __android_log_print value:${args[3].toInt32()} addr:${args[3]}`);
                        }else{
                            send(` __android_log_print addr:${args[3]}`);
                        }
                        
                    }
                    if(args[4]){
                        try{
                            send(` __android_log_print value:${args[4].readUtf8String} addr:${args[4]}`);
                        }catch(e){
                            send(` __android_log_print addr:${args[4]}`);
                        }
                    }
                }
            });
            ...
            Interceptor.attach(Module.findExportByName(sofile, "fwrite"), {
                onEnter: function (args) {
                    ...
                    send(` fwrite ${args[1].readUtf8String()}`);
                    send(` fwrite ${args[2].readUtf8String()}`);
                }
            });
            Interceptor.attach(Module.findExportByName(sofile, "sprintf"), {
                onEnter: function (args) {
                    send(` sprintf value:${args[0]}`);
                    try{
                        send(` sprintf value:${args[1].readUtf8String()} addr:${args[1]}`);
                    }catch(e){
                        send(` sprintf addr:${args[1]}`);
                    }
                }
            });
            Interceptor.attach(Module.findExportByName(sofile, "fprintf"), {
                onEnter: function (args) {
                    send(` fprintf addr:${args[0]}`);
                    try{
                        send(` fprintf value:${args[1].readUtf8String()} addr:${args[1]}`);
                    }catch(e){
                        send(` fprintf addr:${args[1]}`);
                    }
                }
            });
            ...
            Interceptor.attach(Module.findExportByName(sofile, "write"), {
                onEnter: function (args) {
                    send(` write addr:${args[0]}`);
                    try{
                        send(` write value:${args[1].readUtf8String()} addr:${args[1]}`);
                    } catch (e){
                        send(` write addr:${args[1]}`);
                    }
                }
            });
            Interceptor.attach(Module.findExportByName(sofile, "fread"), {
                onEnter: function (args) {
                    try{
                        send(` fread value:${args[0].readUtf8String()}`);
                        send(` fread value:${args[1].toInt32()}`);
                        send(` fread value:${args[2].toInt32()}`);
                        send(` fread addr:${args[3]}`);
                    }catch{
                        send(` fread enter`);
                    }
            ...
            Interceptor.attach(Module.findExportByName(sofile, "send"), {
                onEnter: function (args) {
                    try{
                        send(` send: value:${args[1].readUtf8String()} addr:${args[1]}`);
                    } catch (e){
                        send(` send: addr:${args[1]}`);
                    }
                },
                onLeave: function (retval){
                    if (retval.toInt32()==-1)
            ...
            Interceptor.attach(Module.findExportByName(sofile, "sendto"), {
                onEnter: function (args) {
                    try{
                        send(` sendto: value:${args[1].readUtf8String()} addr:${args[1]}`);
                    } catch (e){
                        send(` sendto: addr:${args[1]}`);
                    }
                },
                onLeave: function (retval){
                    // if (retval.toInt32()==-1)
            ...
            Interceptor.attach(Module.findExportByName(sofile, "recv"), {
                onEnter: function (args) {
                    send(` recv ${args[2].readUtf8String()}`);
                }
            });
            ...
            Interceptor.attach(Module.findExportByName(sofile, "recvfrom"), {
                onEnter: function (args) {
                    send(` recvfrom `);
                    try{
                        send(` recvfrom:${args[2].readUtf8String()}`);
                    } catch (e){
                        send(" recvfrom args[2]");
                    }
                },
                onLeave: function (retval){
                    // if (retval.toInt32()<0)
            ...
            Interceptor.attach(Module.findExportByName(sofile, "atoll"), {
                ...
                onLeave: function(retval){
                    send(` atoll trace-value:${this.par.readUtf8String()}->${retval.toInt32()}`);
                    send(` atoll trace-addr:${this.par}->${retval}`);
                }
            });
            Interceptor.attach(Module.findExportByName(sofile, "atoi"), {
                ...
                onLeave: function(retval){
                    send(` atoi trace-value:${this.par.readUtf8String()}->${retval.toInt32()}`);
                    send(` atoi trace-addr:${this.par}->${retval}`);
                }
            });
            //str
            ...
            //     onEnter: function (args) {
            //         send(` strncpy trace-value:${args[1].readUtf8String()}->${args[0].readUtf8String()}`);
            //         send(` strncpy trace-addr:${args[1]}->${args[0]}`);
            //     }
            // });
            // Interceptor.attach(Module.findExportByName(sofile, "memcpy"), {
            //     onEnter: function (args) {
            //         try{
            //             send(` memcpy trace-value:${args[1].readUtf8String()}->${args[0].readUtf8String()}`);
            //         }catch(e){
            //             console.log("memcpy");
            //         }
            //         try{
            //             send(` memcpy trace-addr:${args[1]}->${args[0]}`);
            //         }catch(e){
            //             console.log("memcpy");
            //         }
            //     }
        ...
        // entrypoint
        send("start");
        for (let index in so_files) {
            try{
                hook_custom_sys(so_files[index]);
            } catch (e){
                send("hook sys failed.");
            }
        }

        hook_all_jni();
        Java.perform(function () {
            Interceptor.attach(Module.findExportByName("libandroidndkgif.so", "Java_com_waynejo_androidndkgif_GifDecoder_nativeBitmapIteratorHasNext"), {
                onEnter: function (args) {
                    send(" [+] enter Java_com_waynejo_androidndkgif_GifDecoder_nativeBitmapIteratorHasNext");
                },
                onLeave(retval){
                    try{
                        send(` funreturn: addr:${retval}`);
                    } catch(e) {
                        send(` funreturn: addr:${retval}`);
                    }
                    send(" [+] leave Java_com_waynejo_androidndkgif_GifDecoder_nativeBitmapIteratorHasNext \n\n");
                }
            });
        });
        //hook_custom_jni();
