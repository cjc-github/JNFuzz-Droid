...
int main(int argc, char** argv)
{
    ...
    jstring str0 = "/data/local/tmp/libnative-lib.so";
    ...
    jni0_t jni0 = dlsym(handle0, "Java_lu_uni_trux_leaker_1imei_MainActivity_nativeLeaker");
    ...
    jclass class0 = (*env)->FindClass(env, "lu/uni/trux/leaker_imei/MainActivity");
    if(class0 == NULL){
