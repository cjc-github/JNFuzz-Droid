...
int main(int argc, char** argv)
{
    ...
    jstring str0 = "/data/local/tmp/libandroidndkgif.so";
    ...
    typedef jboolean (*jni0_t)(JNIEnv *env, jclass class,jlong i1);
    jni0_t jni0 = dlsym(handle0, "Java_com_waynejo_androidndkgif_GifDecoder_nativeBitmapIteratorHasNext");
    ...
    jclass class0 = (*env)->FindClass(env, "com/waynejo/androidndkgif/GifDecoder");
    if(class0 == NULL){
    ...
    while (1)
    {
        ...
        if (n_read > 0)
        {
            ...
            char* data=buf;
            if(strlen(data)>=8){
            jlong par1 = getjni_long(data,0);
            jboolean par0 = jni0(env,class0, par1);
            }
