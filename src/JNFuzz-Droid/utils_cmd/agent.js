    ...
    1: [function (require, module, exports) {
        ...
        function CallXXXXMethodX(name, args) {
            ...
            if (jmethodIDs.has(`${args[2]}`)) {
                send(` JNIENv->${name} ${class_name.replaceAll(".", "/")}->${jmethodIDs.get(`${args[2]}`)}`);
                if (jmethodIDs.get(`${args[2]}`).includes("sendTextMessage(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/app/PendingIntent;Landroid/app/PendingIntent;)V")){
                    send("sendTextMessage sink:"+args[3]);
                    var phone = Java.vm.getEnv().getStringUtfChars(args[3].add(0).readPointer()).readUtf8String();
                    var sendtext = Java.vm.getEnv().getStringUtfChars(args[3].add(8).readPointer()).readUtf8String();
                    try{
                        send(` sendTextMessage[1] value:${phone} addr:${args[3].add(0)}`);
                        send(` sendTextMessage[3] value:${sendtext} addr:${args[3].add(8)}`);
                    }catch(e){
                        send(` sendTextMessage[1] addr:${args[3].add(0)}`);
                        send(` sendTextMessage[3] addr:${args[3].add(8)}`);
                    }
                }
            }
        }
        function CallXXXXMethodXRET(name, args) {
            let class_name = Java.vm.tryGetEnv().getObjectClassName(args[1]);
            if (jmethodIDs.has(`${args[2]}`)) {
                if (jmethodIDs.get(`${args[2]}`).includes("putExtra(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;") && class_name.includes("android.content.Intent")){
                    // try{
                    //     send(` putExtra[1] value:${Java.vm.tryGetEnv().getStringUtfChars(args[3]).readUtf8String()} addr:${args[3]}`);
                    //     send(` putExtra[2] value:${Java.vm.getEnv().getStringUtfChars(args[4]).readUtf8String()} addr:${args[4]}`);
                    // }catch(e){
                    //     send(` putExtra[1] addr:${args[3]}`);
                    //     send(` putExtra[2] addr:${args[4]}`);
                    // }
                    send(` putExtra[1] addr:${args[3]}`);
                    send(` putExtra[2] addr:${args[4]}`);
                }
                return ` JNIENv->${name} ${class_name.replaceAll(".", "/")}->${jmethodIDs.get(`${args[2]}`)}`;
            }
            return ` JNIENv->${name} ${class_name.replaceAll(".", "/")}->${args[2]}`;
        }
        function CallStaticXXXMethodX(name, args) {
            let class_name = Java.vm.tryGetEnv().getClassName(args[1]);
            if (jmethodIDs.has(`${args[2]}`)) {
                send(` JNIENv->${name} ${class_name.replaceAll(".", "/")}->${jmethodIDs.get(`${args[2]}`)}`);
                if (jmethodIDs.get(`${args[2]}`).includes("(Ljava/lang/String;Ljava/lang/String;)I") && class_name.includes("android.util.Log")){
                    // try{
                    //     send(` LOG[1] value:${Java.vm.tryGetEnv().getStringUtfChars(args[3]).readUtf8String()} addr:${args[3]}`);
                    // }catch(e){
                    //     send(` LOG[1] addr:${args[3]}`);
                    // }

                    // try{
                    //     send(` LOG[2] value:${Java.vm.tryGetEnv().getStringUtfChars(args[4]).readUtf8String()} addr:${args[4]}`);
                    // }catch(e){
                    //     send(` LOG[2] addr:${args[4]}`);
                    // }
                    send(` LOG[1] addr:${args[3]}`);
                    send(` LOG[2] addr:${args[4]}`);
                }
        ...
        function XXXStaticXXXField(name, args) {
            ...
            if (jfieldIDs.has(`${args[2]}`)) {
                send(` JNIENv->${name} ${class_name} ${jfieldIDs.get(`${args[2]}`)}`);
            }
        }
        function XXXStaticXXXFieldRET(name, args) {
            let base_msg = ` JNIENv->${name}`;
            let class_name = Java.vm.tryGetEnv().getClassName(args[1]);
            if (jfieldIDs.has(`${args[2]}`)) {
        ...
        function hook_jni(func_name) {
            ...
            switch (func_name) {
                case "SetByteArrayRegion":
                    listener = Interceptor.attach(getJAddr("SetByteArrayRegion"), {
                        onEnter: function (args) {
                            ...
                            logger_1.log(` JNIENv->SetByteArrayRegion ${buffer_hex}`);
                        }
                    });
                    break;
                case "GetFieldID":
                    listener = Interceptor.attach(getJAddr("GetFieldID"), {
                        ...
                        onLeave(retval) {
                            ...
                            if (show_cache_log)
                                send(` JNIENv->GetFieldID ${this.name} ${this.sig} jfieldID ${retval}`);
                        }
                    });
                    break;
                case "GetObjectField":
                    listener = Interceptor.attach(getJAddr("GetObjectField"), {
                        ...
                        onLeave(retval) {
                            ...
                            if (!switch_flag && this.signature.endsWith(":Ljava/lang/String;")) {
                                ...
                                send(`${this.base_msg} ${this.signature} ${retval}`);
                            }
                        }
                    });
                    break;
                case "GetBooleanField":
                    listener = Interceptor.attach(getJAddr("GetBooleanField"), { 
                        onEnter(args) { 
                            [this.base_msg, this.signature] = XXXFieldRET("GetBooleanField", args); 
                        }, onLeave(retval) { 
                            send(`${this.base_msg} ${this.signature} ${Boolean(retval.toUInt32())}`); 
                        } 
                    });
                    break;
                case "GetByteField":
                    listener = Interceptor.attach(getJAddr("GetByteField"), { 
                        onEnter(args) { 
                            [this.base_msg, this.signature] = XXXFieldRET("GetByteField", args); 
                        }, onLeave(retval) { 
                    ...
                    break;
                case "GetCharField":
                    listener = Interceptor.attach(getJAddr("GetCharField"), { 
                        onEnter(args) { 
                            [this.base_msg, this.signature] = XXXFieldRET("GetCharField", args); 
                        }, onLeave(retval) { 
                            // logger_1.log(`${this.base_msg} ${this.signature} ${retval}`); 
                            send(`${this.base_msg} ${this.signature} ${retval}`); 
                        } 
                    ...
                    break;
                case "GetShortField":
                    listener = Interceptor.attach(getJAddr("GetShortField"), { 
                        onEnter(args) { 
                            [this.base_msg, this.signature] = XXXFieldRET("GetShortField", args); 
                        }, onLeave(retval) { 
                            // logger_1.log(`${this.base_msg} ${this.signature} ${retval.toUInt32()}`); 
                            send(`${this.base_msg} ${this.signature} ${retval.toUInt32()}`); 
                        } 
                    });
                    break;
                case "GetIntField":
                    listener = Interceptor.attach(getJAddr("GetIntField"), { 
                        onEnter(args) { 
                            [this.base_msg, this.signature] = XXXFieldRET("GetIntField", args); 
                        }, onLeave(retval) { 
                            // logger_1.log(`${this.base_msg} ${this.signature} ${retval.toUInt32()}`); 
                            send(`${this.base_msg} ${this.signature} ${retval.toUInt32()}`); 
                        } 
                    ...
                    listener = Interceptor.attach(getJAddr("GetLongField"), {
                        ...
                        onLeave(retval) {
                            if (!blacklist_XXXField.includes(this.class_name)) {
                                ...
                                send(`${this.base_msg} ${this.signature} ${retval.toUInt32()}L`);
                            }
                        }
                    });
                    break;
                case "GetFloatField":
                    listener = Interceptor.attach(getJAddr("GetFloatField"), { 
                        onEnter(args) { 
                            [this.base_msg, this.signature] = XXXFieldRET("GetFloatField", args); 
                        }, onLeave(retval) { 
                            // logger_1.log(`${this.base_msg} ${this.signature} ${retval}`); 
                            send(`${this.base_msg} ${this.signature} ${retval}`); 
                        } 
                    ...
                    break;
                case "GetDoubleField":
                    listener = Interceptor.attach(getJAddr("GetDoubleField"), { 
                        onEnter(args) { 
                            [this.base_msg, this.signature] = XXXFieldRET("GetDoubleField", args); 
                        }, onLeave(retval) { 
                            // logger_1.log(`${this.base_msg} ${this.signature} ${retval}`); 
                            send(`${this.base_msg} ${this.signature} ${retval}`);
                        } 
                    ...
                    listener = Interceptor.attach(getJAddr("SetObjectField"), {
                        onEnter(args) {
                            ...
                            if (this.signature.endsWith(":Ljava/lang/String;")) {
                                ...
                                send(`${this.base_msg} ${this.signature} ${val}`);
                            }
                        }
                    });
                    break;
                case "SetBooleanField":
                    listener = Interceptor.attach(getJAddr("SetBooleanField"), { 
                        onEnter(args) { 
                            // logger_1.log(`${XXXFieldRET("SetBooleanField", args)} ${Boolean(args[3].toUInt32())}`); 
                            send(`${XXXFieldRET("SetBooleanField", args)} ${Boolean(args[3].toUInt32())}`); 
                        } 
                    });
                    break;
                case "SetByteField":
                    listener = Interceptor.attach(getJAddr("SetByteField"), { 
                        onEnter(args) { 
                            // logger_1.log(`${XXXFieldRET("SetByteField", args)} ${args[3]}`); 
                            send(`${XXXFieldRET("SetByteField", args)} ${args[3]}`); 
                        } 
                    });
                    break;
                case "SetCharField":
                    listener = Interceptor.attach(getJAddr("SetCharField"), { 
                        onEnter(args) { 
                            // logger_1.log(`${XXXFieldRET("SetCharField", args)} ${args[3]}`); 
                            send(`${XXXFieldRET("SetCharField", args)} ${args[3]}`); 
                        } 
                    });
                    break;
                case "SetShortField":
                    listener = Interceptor.attach(getJAddr("SetShortField"), { 
                        onEnter(args) { 
                            // logger_1.log(`${XXXFieldRET("SetShortField", args)} ${args[3].toUInt32()}`); 
                            send(`${XXXFieldRET("SetShortField", args)} ${args[3].toUInt32()}`); 
                        } 
                    });
                    break;
                case "SetIntField":
                    listener = Interceptor.attach(getJAddr("SetIntField"), {
                        onEnter(args) {
                            ...
                            if (!blacklist_XXXField.includes(this.class_name)) {
                                ...
                                send(`${this.base_msg} ${this.signature} ${args[3].toUInt32()}`);
                            }
                        }
                    });
                    break;
                case "SetLongField":
                    ...
                    break;
                case "SetFloatField":
                    listener = Interceptor.attach(getJAddr("SetFloatField"), { 
                        onEnter(args) { 
                            // logger_1.log(`${XXXFieldRET("SetFloatField", args)} ${args[3]}`); 
                            send(`${XXXFieldRET("SetFloatField", args)} ${args[3]}`);
                        } 
                    });
                    break;
                case "SetDoubleField":
                    listener = Interceptor.attach(getJAddr("SetDoubleField"), { 
                        onEnter(args) { 
                            // logger_1.log(`${XXXFieldRET("SetDoubleField", args)} ${args[3]}`); 
                            send(`${XXXFieldRET("SetDoubleField", args)} ${args[3]}`); 
                        } 
                    });
                    break;
                    ...
                    listener = Interceptor.attach(getJAddr("GetStaticFieldID"), {
                        ...
                        onLeave(retval) {
                            ...
                            if (show_cache_log)
                                ...
                                send(` JNIENv->GetStaticFieldID ${this.name} ${this.sig} jfieldID ${retval}`);
                        }
                    });
                    break;
                ...
                case "GetStaticBooleanField":
                    listener = Interceptor.attach(getJAddr("GetStaticBooleanField"), { 
                        onEnter(args) { 
                            [this.base_msg, this.signature] = XXXStaticXXXFieldRET("GetStaticBooleanField", args); 
                        }, onLeave(retval) { 
                            // logger_1.log(`${this.base_msg} ${this.signature} ${Boolean(retval.toUInt32())}`); 
                            send(`${this.base_msg} ${this.signature} ${Boolean(retval.toUInt32())}`); 
                        } 
                    });
                    break;
                case "GetStaticByteField":
                    listener = Interceptor.attach(getJAddr("GetStaticByteField"), { 
                        onEnter(args) { 
                            [this.base_msg, this.signature] = XXXStaticXXXFieldRET("GetStaticByteField", args); 
                        }, onLeave(retval) { 
                            // logger_1.log(`${this.base_msg} ${this.signature} ${retval}`); 
                            send(`${this.base_msg} ${this.signature} ${retval}`); 
                        } 
                ...
                case "GetStaticCharField":
                    listener = Interceptor.attach(getJAddr("GetStaticCharField"), { 
                        onEnter(args) { 
                            [this.base_msg, this.signature] = XXXStaticXXXFieldRET("GetStaticCharField", args); 
                        }, onLeave(retval) { 
                            // logger_1.log(`${this.base_msg} ${this.signature} ${retval}`); 
                            send(`${this.base_msg} ${this.signature} ${retval}`); 
                        } 
                ...
                case "GetStaticFloatField":
                    listener = Interceptor.attach(getJAddr("GetStaticFloatField"), { 
                        onEnter(args) { 
                            [this.base_msg, this.signature] = XXXStaticXXXFieldRET("GetStaticFloatField", args); 
                        }, onLeave(retval) { 
                            // logger_1.log(`${this.base_msg} ${this.signature} ${retval}`); 
                            send(`${this.base_msg} ${this.signature} ${retval}`); 
                        } 
                ...
                case "GetStaticDoubleField":
                    listener = Interceptor.attach(getJAddr("GetStaticDoubleField"), { 
                        onEnter(args) { 
                            [this.base_msg, this.signature] = XXXStaticXXXFieldRET("GetStaticDoubleField", args); 
                        }, onLeave(retval) { 
                            // logger_1.log(`${this.base_msg} ${this.signature} ${retval}`); 
                            send(`${this.base_msg} ${this.signature} ${retval}`); 
                        } 
                ...
                case "NewStringUTF":
                    listener = Interceptor.attach(getJAddr("NewStringUTF"), {
                        onEnter: function (args) {
                            ...
                            // send(`JNIEnv->NewStringUTF ${ptr(args[1]).readCString()}`);
                            // var string = Memory.readCString(args[1]);
                            // send(` JNIEnv->NewStringUTF in-value:${string}`)
                            send(` JNIENv->NewStringUTF in-value:${args[0].readUtf8String()} in-addr:${args[0]}`);
                        },
                        onLeave:function(retval) {
                            // send(` JNIEnv->NewStringUTF return: value: ${Java.vm.tryGetEnv().getStringUtfChars(retval).readUtf8String()} addr:${retval}`);
                            // send(` JNIEnv->NewStringUTF return: value: ${retval.readUtf8String()} addr:${retval}`);
                            // send(` JNIEnv->NewStringUTF addr:${retval}`);
                            let msg;
                            try {
                            ...
                            if (msg) {
                                ...
                                send(` JNIENv->NewStringUTF out-value:${msg} out-addr:${retval}`);
                            }else{
                                send(` JNIEnv->NewStringUTF out-addr:${retval}`);
                            }
                        }
                    });
                    break;
                case "GetStringUTFChars":
                    listener = Interceptor.attach(getJAddr("GetStringUTFChars"), {
                        ...
                        onLeave: function (retval) {
                            send(` JNIEnv->GetStringUTFChars[1] trace-value:${Java.vm.tryGetEnv().getStringUtfChars(this.par).readUtf8String()}->${retval.readUtf8String()}`);
                            send(` JNIEnv->GetStringUTFChars[1] trace-addr:${this.par}->${retval}`);
                            // let msg;
                            // try {
                            //     msg = retval.readUtf8String();
                            // }
                            ...
                            // if (msg) {
                            //     // logger_1.log(`/* TID ${gettid()} */ JNIENv->GetStringUTFChars ${msg}`);
                            //     send(` JNIENv->GetStringUTFChars out-value:${msg} out-addr:${retval}`);
                            // }
                        }
                    });
                    break;
                case "FindClass":
                    listener = Interceptor.attach(getJAddr("FindClass"), {
                        onEnter: function (args) {
                            ...
                            // send(` JNIENv->FindClass ${args[1].readUtf8String()}`);
                            if (args[1] != null) {
                                ...
                                if (module != null) {
                                    ...
                                    send("[NewStringUTF] name:"+string+" addr:"+args[1]);
                                }
                    ...
                    listener = Interceptor.attach(getJAddr("GetMethodID"), {
                        ...
                        onLeave(retval) {
                            ...
                            if (show_cache_log)
                                ...
                                send(` JNIENv->GetMethodID ${this.name}->${this.sig} jmethodID ${retval}`);
                        }
                    });
                    break;
                ...
                case "CallVoidMethodV":
                    listener = Interceptor.attach(getJAddr("CallVoidMethodV"), { 
                        onEnter(args) { 
                            CallXXXXMethodX("CallVoidMethodV", args);
                            console.log(" [+] enter the callvoidmethodv");
                        }
                 });
                    break;
                case "CallVoidMethodA":
                    listener = Interceptor.attach(getJAddr("CallVoidMethodA"), {
                        onEnter(args) {
                            CallXXXXMethodX("CallVoidMethodA", args);
                        }
                    });
                    break;
                    ...
                    listener = Interceptor.attach(getJAddr("GetStaticMethodID"), {
                        ...
                        onLeave(retval) {
                            ...
                            if (show_cache_log)
                                ...
                                send(` JNIENv->GetStaticMethodID ${this.name}->${this.sig} jmethodID ${retval}`);
                        }
                    });
                    break;
        ...
        function hook_custom_sys(sofile) {
            Interceptor.attach(Module.findExportByName(sofile, "__android_log_write"), {
                onEnter: function (args) {
                    send(` __android_log_write[1] addr:${args[1].readUtf8String()}`);
                    send(` __android_log_write[2] addr:${args[2].readUtf8String()}`);
                    if (args[2].readUtf8String().indexOf("%s")!=-1){
                        send(` __android_log_write[2] value:${args[3].readUtf8String()} addr:${args[3]}`);
                    }else
                    {
                        send(` __android_log_write[2] addr:${args[3]}`);
                    }
                }
            });
            Interceptor.attach(Module.findExportByName(sofile, "atoll"), {
                onEnter: function (args) {
                    this.par=args[0];
                },
                onLeave: function(retval){
                    send(` atoll[1] trace-value:${this.par.readUtf8String()}->${retval.toInt32()}`);
                    send(` atoll[1] trace-addr:${this.par}->${retval}`);
                }
            });
            Interceptor.attach(Module.findExportByName(sofile, "__android_log_print"), {
                onEnter: function (args) {
                    console.log(` __android_log_print[1] value:${args[1].readUtf8String()}`);
                    console.log(` __android_log_print[2] value:${args[2].readUtf8String()}`);
                    if (args[2].readUtf8String().indexOf("%s")!=-1){
                        send(` __android_log_print[2] value:${args[3].readUtf8String()} addr:${args[3]}`);
                    }else
                    {
                        if(args[2].readUtf8String().indexOf("%lld")!=-1){
                            send(` __android_log_print[2] value:${args[3].toInt32()} addr:${args[3]}`);
                        }else{
                            send(` __android_log_print[2] addr:${args[3]}`);
                        }
                        
                    }
                    if(args[4]){
                        try{
                            send(` __android_log_print[3] value:${args[4].readUtf8String} addr:${args[4]}`);
                        }catch(e){
                            send(` __android_log_print[3] addr:${args[4]}`);
                        }
                    }
                }
            });
            Interceptor.attach(Module.findExportByName(sofile, "fopen"), {
                onEnter: function (args) {
                    send(` fopen args[0] value:${args[0].readUtf8String()}`);
                    send(` fopen args[1] value:${args[1].readUtf8String()}`);
                },
                onLeave: function(retval){
                    send(`atoi value: ${retval.toInt32()} addr: ${retval}`)
                }
            });
            Interceptor.attach(Module.findExportByName(sofile, "open"), {
                onEnter: function (args) {
                    send(` open args[0] value:${args[0].readUtf8String()}`);
                    send(` open args[1] value:${args[1].toInt32()}`);
                },
                onLeave: function(retval){
                    send(` open return value:${retval.toInt32()} addr: ${retval}`);
                }
            });
            Interceptor.attach(Module.findExportByName(sofile, "dlopen"), {
                onEnter: function (args) {
                    send(` dlopen args[0] value:${args[0].readUtf8String()}`);
                    send(` dlopen args[1] value:${args[1].toInt32()}`);
                },
                onLeave: function(retval){
                    send(` dlopen return addr:${retval}`);
                }
            });
            // Interceptor.attach(Module.findExportByName(sofile, "dlmopen"), {
            //     onEnter: function (args) {
            //         send(` dlmopen args[1] value:${args[0].readUtf8String()}`);
            //         send(` dlmopen args[2] value:${args[1].toInt32()}`);
            //     },
            //     onLeave: function(retval){
            //         send(` dlmopen return addr:${retval}`);
            //     }
            // });
            Interceptor.attach(Module.findExportByName(sofile, "dlsym"), {
                onEnter: function (args) {
                    send(` dlsym args[0] addr:${args[0]}`);
                    send(` dlsym args[1] value:${args[1].readUtf8String()}`);
                },
                onLeave: function(retval){
                    send(` dlsym return addr:${retval}`);
                }
            });
            // Interceptor.attach(Module.findExportByName(sofile, "dlvsym"), {
            //     onEnter: function (args) {
            //         send(` dlvsym args[0] addr:${args[0]}`);
            //         send(` dlvsym args[1] value:${args[1].readUtf8String()}`);
            //         send(` dlvsym args[1] value:${args[2].readUtf8String()}`);
            //     },
            //     onLeave: function(retval){
            //         send(` dlvsym return addr:${retval}`);
            //     }
            // });
            Interceptor.attach(Module.findExportByName(sofile, "fork"), {
                onEnter: function (args) {
                    send(`fork start`);
                },
                onLeave:function(retval){
            ...
            Interceptor.attach(Module.findExportByName(sofile, "fwrite"), {
                onEnter: function (args) {
                    try{
                        send(` fwrite ${args[0].readUtf8String()}`);
                    }catch(e){
                        send(` fwrite addr:${args[0]}`);
                    }
                    send(` fwrite[1] ${args[1].readUtf8String()}`);
                    send(` fwrite[2] ${args[2].readUtf8String()}`);
                }
            });
            // Interceptor.attach(Module.findExportByName(sofile, "*printf"), {
            //     onEnter: function (args) {
            //         send(` *printf value:${args[0]}`);
            //         try{
            //             send(` *printf value:${args[1].readUtf8String()} addr:${args[1]}`);
            //         }catch(e){
            //             send(` *printf addr:${args[1]}`);
            //         }
            //     }
            // });
            Interceptor.attach(Module.findExportByName(sofile, "write"), {
                onEnter: function (args) {
                    send(` write[1] addr:${args[0]}`);
                    try{
                        send(` write[2] value:${args[1].readUtf8String()} addr:${args[1]}`);
                    } catch (e){
                        send(` write[2] addr:${args[1]}`);
                    }
                }
            });
            Interceptor.attach(Module.findExportByName(sofile, "connect"), {
                onEnter: function (args) {
                    send(` connect function`);
                }
            });
            Interceptor.attach(Module.findExportByName(sofile, "listen"), {
                onEnter: function (args) {
                    send(` listen function`);
                }
            });
            Interceptor.attach(Module.findExportByName(sofile, "bind"), {
                onEnter: function (args) {
                    send(` bind function`);
                }
            });
            Interceptor.attach(Module.findExportByName(sofile, "accept"), {
                onEnter: function (args) {
                    send(` accept function`);
                }
            });
            Interceptor.attach(Module.findExportByName(sofile, "select"), {
                onEnter: function (args) {
                    send(` select function`);
                }
            });
            Interceptor.attach(Module.findExportByName(sofile, "read"), {
                onEnter: function (args) {
                    try{
                        args[0]=ptr(0)
                        args[2]=ptr(0);
                        //send(` read value:${args[0].readUtf8String()}`);
                        //send(` read value:${args[1].toInt32()}`);
                        //send(` read value:${args[2].toInt32()}`);
                        //send(` read addr:${args[3]}`);
                    }catch{
                        send(` read enter`);
                    }
            ...
            Interceptor.attach(Module.findExportByName(sofile, "fread"), {
                onEnter: function (args) {
                    try{
                        send(` fread[1] value:${args[0].readUtf8String()}`);
                        send(` fread[2] value:${args[1].toInt32()}`);
                        send(` fread[3] value:${args[2].toInt32()}`);
                        send(` fread[4] addr:${args[3]}`);
                    }catch{
                        send(` fread enter`);
                    }
            ...
            Interceptor.attach(Module.findExportByName(sofile, "scandir"), {
                onEnter: function (args) {
                    send(` scandir value:${args[0].readUtf8String()}`);
                }
            });
            Interceptor.attach(Module.findExportByName(sofile, "send"), {
                onEnter: function (args) {
                    try{
                        send(` send[2] value:${args[1].readUtf8String()} addr:${args[1]}`);
                    } catch (e){
                        send(` send[2] addr:${args[1]}`);
                    }
                },
                onLeave: function (retval){
                    if (retval.toInt32()==-1)
            ...
            Interceptor.attach(Module.findExportByName(sofile, "sendto"), {
                onEnter: function (args) {
                    try{
                        send(` sendto[2] value:${args[1].readUtf8String()} addr:${args[1]}`);
                    } catch (e){
                        send(` sendto[2] addr:${args[1]}`);
                    }
                },
                onLeave: function (retval){
                    // if (retval.toInt32()==-1)
            ...
            // Interceptor.attach(Module.findExportByName(sofile, "fput*"), {
            //     onEnter: function (args) {
            //         try{
            //             send(` fput*: value:${args[1].readUtf8String()} addr:${args[1]}`);
            //         } catch (e){
            //             send(` fput*: addr:${args[1]}`);
            //         }
            //     },
            //     onLeave: function (retval){
            //         send(" fput* end");
            //     }
            // });
            Interceptor.attach(Module.findExportByName(sofile, "system"), {
                onEnter: function (args) {
                    try{
                        send(` system[1]: value:${args[0].readUtf8String()} addr:${args[1]}`);
                    } catch (e){
                        send(` system[1]: addr:${args[0]}`);
                    }
                },
                onLeave: function (retval){
                    send(" system end");
            ...
            Interceptor.attach(Module.findExportByName(sofile, "popen"), {
                onEnter: function (args) {
                    try{
                        send(` popen: value:${args[0].readUtf8String()} addr:${args[1]}`);
                    } catch (e){
                        send(` popen: addr:${args[0]}`);
                    }
                },
                onLeave: function (retval){
                    send(" popen end");
            ...
            Interceptor.attach(Module.findExportByName(sofile, "recv"), {
                onEnter: function (args) {
                    try{
                        send(` recv[2]: value:${args[2].readUtf8String()} addr:${args[2]}`);
                    }catch(e){
                        send(` recv[2]: addr:${args[2]}`);
                    }
                }
            });
            Interceptor.attach(Module.findExportByName(sofile, "inet_addr"), {
                onEnter: function (args) {
                    //args[0]=ptr("127.0.0.1");
                    try{
                        send(` inet_addr value:${args[0].readUtf8String()} addr:${args[0]}`);
                    } catch (e){
                        send(` inet_addr addr:${args[0]}`);
                    }
                },
                onLeave: function (retval){
                    // if (retval.toInt32()<0)
            ...
            Interceptor.attach(Module.findExportByName(sofile, "recvfrom"), {
                onEnter: function (args) {
                    send(` recvfrom `);
                    try{
                        send(` recvfrom[2]: value:${args[2].readUtf8String()} addr:${args[2]}`);
                    } catch (e){
                        send(` recvfrom[2]: addr:${args[2]}`);
                    }
                },
                onLeave: function (retval){
                    // if (retval.toInt32()<0)
            ...
            Interceptor.attach(Module.findExportByName(sofile, "execl"), {
                onEnter: function (args) {
                    for(let i=0;i<=10;i++)
                    {
                        try{
                            let v=args[`${i}`].readUtf8String();
                            send(` execl[] value:${args[`${i}`].readUtf8String()} addr:${args[`${i}`]}`);
                            if(v==null){
                                break;
                            }
                        }catch(e){
            ...
            Interceptor.attach(Module.findExportByName(sofile, "execle"), {
                onEnter: function (args) {
                    for(let i=0;i<=10;i++)
                    {
                        try{
                            let v=args[`${i}`].readUtf8String();
                            send(` execle[] value:${args[`${i}`].readUtf8String()} addr:${args[`${i}`]}`);
                            if(v==null){
                                break;
                            }
                        }catch(e){
            ...
            Interceptor.attach(Module.findExportByName(sofile, "execlp"), {
                onEnter: function (args) {
                    for(let i=0;i<=10;i++)
                    {
                        try{
                            let v=args[`${i}`].readUtf8String();
                            send(` execlp[] value:${args[`${i}`].readUtf8String()} addr:${args[`${i}`]}`);
                            if(v==null){
                                break;
                            }
                        }catch(e){
            ...
            Interceptor.attach(Module.findExportByName(sofile, "execv"), {
                onEnter: function (args) {
                    for(let i=0;i<=10;i++)
                    {
                        try{
                            let v=args[`${i}`].readUtf8String();
                            send(` execv[] value:${args[`${i}`].readUtf8String()} addr:${args[`${i}`]}`);
                            if(v==null){
                                break;
                            }
                        }catch(e){
            ...
            Interceptor.attach(Module.findExportByName(sofile, "execve"), {
                onEnter: function (args) {
                    for(let i=0;i<=10;i++)
                    {
                        try{
                            let v=args[`${i}`].readUtf8String();
                            send(` execve[] value:${args[`${i}`].readUtf8String()} addr:${args[`${i}`]}`);
                            if(v==null){
                                break;
                            }
                        }catch(e){
            ...
            Interceptor.attach(Module.findExportByName(sofile, "execvp"), {
                onEnter: function (args) {
                    for(let i=0;i<=10;i++)
                    {
                        try{
                            let v=args[`${i}`].readUtf8String();
                            send(` execvp[] value:${args[`${i}`].readUtf8String()} addr:${args[`${i}`]}`);
                            if(v==null){
                                break;
                            }
                        }catch(e){
            ...
            Interceptor.attach(Module.findExportByName(sofile, "connect"), {
                onEnter: function (args) {
                    send(` connect: ${args[1].readUtf8String()}`);
                },
                onLeave: function (retval){
                    send(`${retval.toInt32()}`);
                    if (retval.toInt32()<0)
            ...
            Interceptor.attach(Module.findExportByName(sofile, "inotify_init"), {
                onEnter: function (args) {
                    send(` inotify_init`);
                },
                onLeave: function (retval){
                    ...
                    send(" inotify_init end");
                }
            });
            Interceptor.attach(Module.findExportByName(sofile, "inotify_add_watch"), {
                onEnter: function (args) {
                    send(` inotify_add_watch`);
                },
                onLeave: function (retval){
                    if (retval.toInt32()<0)
                    {
                    ...
                    send(" inotify_add_watch end");
                }
            });
            Interceptor.attach(Module.findExportByName(sofile, "inotify_rm_watch"), {
                onEnter: function (args) {
                    send(` inotify_rm_watch`);
                }
            });
            Interceptor.attach(Module.findExportByName(sofile, "socket"), {
                onEnter: function (args) {
                    send(` socket enter`);
                },
                onLeave: function (retval){
                    ...
                    //     retval.replace(12);
                    // }
                    send(` socket end return:${retval.toInt32()} addr:${retval}`);
                }
            });
            Interceptor.attach(Module.findExportByName(sofile, "setscokopt"), {
                onEnter: function (args) {
                    send(` setsocketopt args[1]:${args[1]} args[2]:${args[2]}`);

                },
                onLeave: function (retval){
                    send(` setsockopt end return:${retval.toInt32()} addr:${retval}`);
                }
            });
            Interceptor.attach(Module.findExportByName(sofile, "inet_aton"), {
                onEnter: function (args) {
                    send(` inet_aton args[0]:${args[0].readUtf8String()} args[1]:${args[1].readUtf8String()}`);
                    send(` inet_aton args[0]:${args[0].readUtf8String()} args[1]:${args[1].readUtf8String()}`);

                },
                onLeave: function (retval){
                    send(` inet_aton end return:${retval.toInt32()}`);
                }
            });
            Interceptor.attach(Module.findExportByName(sofile, "gethostbyname"), {
                onEnter: function (args) {
                    //Memory.writeUtf8String(args[0], "www.baidu.com");
                    //args[0]=ptr("www.baidu.com");
                    send(` gethostbyname enter`);
                },
                onLeave: function (retval){
                    if (retval.toInt32()<0)
                    {
                    ...
                    send(` gethostbyname end return:${retval.toInt32()} addr:${retval}`);
                }
            });
            Interceptor.attach(Module.findExportByName(sofile, "atol"), {
                onEnter: function (args) {
                    this.par=args[0];
                },
                onLeave: function(retval){
                    send(` atol[1]: trace-value:${this.par.readUtf8String()}->${retval.toInt32()}`);
                    send(` atol[1]: trace-addr:${this.par}->${retval}`);
                }
            });
            Interceptor.attach(Module.findExportByName(sofile, "atoll"), {
                onEnter: function (args) {
            ...
            Interceptor.attach(Module.findExportByName(sofile, "atoi"), {
                onEnter: function (args) {
                    this.par=args[0];
                },
                onLeave: function(retval){
                    send(` atoi[1]: trace-value:${this.par.readUtf8String()}->${retval.toInt32()}`);
                    send(` atoi[1]: trace-addr:${this.par}->${retval}`);
                }
            });
            Interceptor.attach(Module.findExportByName(sofile, "kill"), {
                onEnter: function (args) {
                    send(`kill trace-value:${args[0].toInt32()} trace-addr:${args[0]}`);
                }
            });
            Interceptor.attach(Module.findExportByName(sofile, "ptrace"), {
                onEnter: function (args) {
                    send(`ptrace`);
                }
            });
            Interceptor.attach(Module.findExportByName(sofile, "getuid"), {
                onEnter: function (args) {
                    send(`getuid`);
                }
            });
            Interceptor.attach(Module.findExportByName(sofile, "geteuid"), {
                onEnter: function (args) {
                    send(`geteuid`);
                }
            });
            Interceptor.attach(Module.findExportByName(sofile, "getgid"), {
                onEnter: function (args) {
                    send(`getgid`);
                }
            });
            Interceptor.attach(Module.findExportByName(sofile, "getegid"), {
                onEnter: function (args) {
                    send(`getegid`);
                }
            });
            Interceptor.attach(Module.findExportByName(sofile, "getpid"), {
                onEnter: function (args) {
                    send(`getpid`);
                }
            });
            Interceptor.attach(Module.findExportByName(sofile, "getepid"), {
                onEnter: function (args) {
                    send(`getepid`);
                }
            });
            Interceptor.attach(Module.findExportByName(sofile, "clock_gettime"), {
                onEnter: function (args) {
                    send(`clock_gettime`);
                }
            });
            Interceptor.attach(Module.findExportByName(sofile, "gettimeofday"), {
                onEnter: function (args) {
                    send(`gettimeofday`);
                }
            });
            // Interceptor.attach(Module.findExportByName(sofile, "*chmod"), {
            //     onEnter: function (args) {
            //         send(`*chmod`);
            //     }
            // });
            // Interceptor.attach(Module.findExportByName(sofile, "*chown"), {
            //     onEnter: function (args) {
            //         send(`*chown`);
            //     }
            // });
            Interceptor.attach(Module.findExportByName(sofile, "access"), {
                onEnter: function (args) {
                    send(`access`);
                }
            });
            ...
            //str
            // Interceptor.attach(Module.findExportByName(sofile, "strcat"), {
            //     onEnter: function (args) {
            //         this.par1=args[0];
            //         this.par2=args[1];
            //     },
            //     onLeave: function(retval){
            //         send(` strcat trace-value:${this.par1.readUtf8String()}->${retval.readUtf8String()}`);
            //         send(` strcat trace-value:${this.par2.readUtf8String()}->${retval.readUtf8String()}`);
            //         send(` strcat trace-addr:${this.par1}->${retval}`);
            //         send(` strcat trace-addr:${this.par2}->${retval}`);
            //     }
            // });
            // Interceptor.attach(Module.findExportByName(sofile, "strdup"), {
            //     onEnter: function (args) {
            //         this.par1=args[0];
            //     },
            //     onLeave: function(retval){
            //         send(` strdup trace-value:${this.par1.readUtf8String()}->${retval.readUtf8String()}`);
            //         send(` strdup trace-addr:${this.par1}->${retval}`);
            //     }
            // });
            // Interceptor.attach(Module.findExportByName(sofile, "strtol"), {
            //     onEnter: function (args) {
            //         this.par1=args[0];
            //     },
            //     onLeave: function(retval){
            //         send(` strtol trace-value:${this.par1.readUtf8String()}->${retval.readUtf8String()}`);
            //         send(` strtol trace-addr:${this.par1}->${retval}`);
            //     }
            // });
            // Interceptor.attach(Module.findExportByName(sofile, "strtoul"), {
            //     onEnter: function (args) {
            //         this.par1=args[0];
            //     },
            //     onLeave: function(retval){
            //         send(` strtoul trace-value:${this.par1.readUtf8String()}->${retval.readUtf8String()}`);
            //         send(` strtoul trace-addr:${this.par1}->${retval}`);
            //     }
            // });
            // Interceptor.attach(Module.findExportByName(sofile, "strtod"), {
            //     onEnter: function (args) {
            //         this.par1=args[0];
            //     },
            //     onLeave: function(retval){
            //         send(` strtod trace-value:${this.par1.readUtf8String()}->${retval.readUtf8String()}`);
            //         send(` strtod trace-addr:${this.par1}->${retval}`);
            //     }
            // });
            // Interceptor.attach(Module.findExportByName(sofile, "strstr"), {
            //     onEnter: function (args) {
            //         send(` strstr args[0]:${args[0].readUtf8String()} args[1]:${args[1].readUtf8String()}`);
            //     }
            // });
            // Interceptor.attach(Module.findExportByName(sofile, "strchr"), {
            //     onEnter: function (args) {
            //         send(` strchr args[0]:${args[0].readUtf8String()} args[1]:${args[1].toInt32()}`);
            //     }
            // });
            // Interceptor.attach(Module.findExportByName(sofile, "strrchr"), {
            //     onEnter: function (args) {
            //         send(` strrchr args[0]:${args[0].readUtf8String()} args[1]:${args[1].toInt32()}`);
            //     }
            // });
            // Interceptor.attach(Module.findExportByName(sofile, "strcmp"), {
            //     onEnter: function (args) {
            //         send(` strcmp args[0]:${args[0].readUtf8String()} args[1]:${args[1].readUtf8String()}`);
            //     }
            // });
            // Interceptor.attach(Module.findExportByName(sofile, "strcasecmp"), {
            //     onEnter: function (args) {
            //         send(` strcasecmp args[0]:${args[0].readUtf8String()} args[1]:${args[1].readUtf8String()}`);
            //     }
            // });
            // Interceptor.attach(Module.findExportByName(sofile, "strncasecmp"), {
            //     onEnter: function (args) {
            //         send(` strncasecmp args[0]:${args[0].readUtf8String()} args[1]:${args[1].readUtf8String()}`);
            //     }
            // });
            // Interceptor.attach(Module.findExportByName(sofile, "strncmp"), {
            //     onEnter: function (args) {
            //         send(` strncmp args[0]:${args[0].readUtf8String()} args[1]:${args[1].readUtf8String()}`);
            //     }
            // });
            // Interceptor.attach(Module.findExportByName(sofile, "strcpy"), {
            //     onEnter: function (args) {
            //         send(` strcpy trace-value:${args[1].readUtf8String()}->${args[0].readUtf8String()}`);
            //         send(` strcpy trace-addr:${args[1]}->${args[0]}`);
            //     }
            // });
            // Interceptor.attach(Module.findExportByName(sofile, "strncpy"), {
            //     onEnter: function (args) {
            //         send(` strncpy[1]: trace-value:${args[1].readUtf8String()}->${args[0].readUtf8String()}`);
            //         send(` strncpy[1]: trace-addr:${args[1]}->${args[0]}`);
            //     }
            // });

            //mem
            // Interceptor.attach(Module.findExportByName(sofile, "memcpy"), {
            //     onEnter: function (args) {
            //         try{
            //             send(` memcpy[1]: trace-value:${args[1].readUtf8String()}->${args[0].readUtf8String()}`);
            //         }catch(e){
            //             console.log("memcpy");
            //         }
            //         try{
            //             send(` memcpy[1]: trace-addr:${args[1]}->${args[0]}`);
            //         }catch(e){
            //             console.log("memcpy");
            //         }
            //     }
            // });
            // Interceptor.attach(Module.findExportByName(sofile, "memcmp"), {
            //     onEnter: function (args) {
            //         send(` memcmp args[0]:${args[0].readUtf8String()} args[1]:${args[1].readUtf8String()}`);
            //     }
            // });
            // Interceptor.attach(Module.findExportByName(sofile, "memmove"), {
            //     onEnter: function (args) {
            //         try{
            //             send(` memmove trace-value:${args[1].readUtf8String()}->${args[0].readUtf8String()}`);
            //         }catch(e){
            //             console.log("memmove value failed");
            //         }
            //         try{
            //             send(` memmove trace-addr:${args[1]}->${args[0]}`);
            //         }catch(e){
            //             console.log("memmove addr failed");
            //         }
            //     }
            // });
            // Interceptor.attach(Module.findExportByName(sofile, "malloc"), {
            //     onEnter: function (args) {
            //         send(` malloc[1]: value:${args[0].toInt32()} addr:${args[0]}`);
            //     }
            // });
            // Interceptor.attach(Module.findExportByName(sofile, "memset"), {
            //     onEnter: function (args) {
            //         send(` memset[1]: value:${args[1].toInt32()} addr:${args[1]}`);
            //     }
            // });
        ...
        Java.perform(function () {
            Interceptor.attach(Module.findExportByName("libswitch1.so", "Java_org_cao_switch1_MainActivity_send"), {
                ...
                onLeave(retval){
                    try{
                        send(` funreturn[0] value:none addr:${retval}`);
                    } catch(e) {
