...
extern "C"
{
    ...
    typedef void function_t(JNIEnv *, jclass,jobjectArray);
}
...
int main(int argc, char *argv[]) {
    targetAppPath = "/data/local/tmp/native_complexdata.apk";
    targetLibName = "/data/local/tmp/libdata.so";
    std::string className="org/arguslab/native_complexdata/MainActivity";
    targetFunctionName="Java_org_arguslab_native_1complexdata_MainActivity_send2";
