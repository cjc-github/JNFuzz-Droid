...
{
    jstring targetLibName = "/data/local/tmp/libleak.so";
    jstring className = "org/arguslab/native_leak/MainActivity";
    jstring targetFunctionName = "Java_org_arguslab_native_1leak_MainActivity_send";
